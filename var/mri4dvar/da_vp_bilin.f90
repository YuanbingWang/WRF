...
!----------------------------------------------------------------------
! Purpose: Regridding increment by using bilinear interpolation
!
...
!----------------------------------------------------------------------
  ...
  real, dimension(:,:,:),   allocatable :: v5
  real, dimension(:,:,:), allocatable :: v1h, v2h, v3h, v4h
  real, dimension(:,:,:),   allocatable :: v5h
